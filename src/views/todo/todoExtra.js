...
class TodoExtra extends Component {
  render() {
    const { unfinishedTodoCount,clearComplet, changeFilter, filter } = this.props.todo;
    return (
      <footer className="footer">
        ...
        <button className="clear-completed" onClick={()=>clearComplet()}>Clear completed</button>
      </footer>
    );
